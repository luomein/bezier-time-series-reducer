...
public struct SingleBezierTimeSeriesPopoverView: View {
    @Binding public var editingState : SingleBezierTimeSeriesReducer.State.PopoverEditingState
    public let title: String
    public init(editingState: Binding<SingleBezierTimeSeriesReducer.State.PopoverEditingState>,
                title: String) {
